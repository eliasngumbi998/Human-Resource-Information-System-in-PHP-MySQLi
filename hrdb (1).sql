...
--
-- Host: localhost
-- Generation Time: Aug 30, 2017 at 05:33 AM
...
CREATE TABLE IF NOT EXISTS `tblcivilserviceeligibility` (
  `CSEID` int(11) NOT NULL AUTO_INCREMENT,
  `EMPLOYEEID` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbleducbackground` (
...
(36, '288', 'DAFFODILS', 'GARCENIEGO', 'CATALUNA', 'KABANKALAN CITY', '1989-05-18', 'ILOILO CITY', 28, 'Female', 'Married', '09175305359', 'AMERICAN', 'BAPTIST', '', '', 'A', '296-810-167', '07-2585122-0', '', 'daffgarceniego@GMAIL.COM', '09175305359', '', '', '', 'STAFF', 'Regular', 12, 4, 'photos/14590490_10209392355380370_7908940572261497605_n.jpg', 'daff', '4277986f0240024a564bce32c8f48538dab5d180', '2000-11-30'),
...
CREATE TABLE IF NOT EXISTS `tblinvolveothercivic` (
  `IOCID` int(11) NOT NULL AUTO_INCREMENT,
  `EMPLOYEEID` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tblinvolveothereducational` (
  `IOEID` int(11) NOT NULL AUTO_INCREMENT,
  `EMPLOYEEID` varchar(30) NOT NULL,
  `NAME_ADDRESS_ORG` varchar(128) NOT NULL,
  `DATEFROM` varchar(30) NOT NULL,
  `DATETO` varchar(30) NOT NULL,
...
--
-- Dumping data for table `tblinvolveothereducational`
--
...
CREATE TABLE IF NOT EXISTS `tblotherinformation` (
  `OTHERINFOID` int(11) NOT NULL AUTO_INCREMENT,
  `EMPLOYEEID` varchar(30) NOT NULL,
  `EMPNAME` varchar(90) NOT NULL,
  `SKILLS` text NOT NULL,
  `NDRA` text NOT NULL,
  PRIMARY KEY (`OTHERINFOID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `tbltrainingprogram` (
...
(8, '288', 'DAFFODILS GARCENIEGO', 'daff', '4277986f0240024a564bce32c8f48538dab5d180', 'HR', 'photos/14590490_10209392355380370_7908940572261497605_n.jpg');
...
CREATE TABLE IF NOT EXISTS `tblworkexperience` (
